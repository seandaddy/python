...
# %%
# URL of the ZIP file
# https://ed-public-download.scorecard.network/downloads/Most-Recent-Cohorts-Institution_10022024.zip
url = "https://ed-public-download.scorecard.network/downloads/Most-Recent-Cohorts-Institution_10022024.zip"
output_filename = "Most-Recent-Cohorts-Institution_10022024.zip"
    ...
    with zipfile.ZipFile(output_filename, "r") as zip_ref:
        ...
        for csv_filename in csv_filenames:
            with zip_ref.open(csv_filename) as csv_file:
                ...
                with open(
                    extracted_csv_path, "w", encoding="utf-8"
                    ...
                    for row in csv_reader:
                        if row["STABBR"] == "PA":
                            ...
                            if (
                                enrollment != "NULL"
                                and enrollment != "NA"
                                and enrollment.isdigit()
                                and int(enrollment) > 5000
                            ):
                                sat = row["SAT_AVG"]
                                if (
                                    sat != "NULL"
